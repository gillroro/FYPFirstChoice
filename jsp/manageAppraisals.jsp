...
<s:select headerKey="-1" headerValue="Select Employee Name" name="appraisal" list="appraisals" listKey="appraisal_id" listValue="accomplishments"  theme = "css_xhtml" ></s:select>
